      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="rounded-lg overflow-hidden mb-4">
            <Image src="/images/asgaard-main.jpg" alt="Asgaard Sofa" width={800} height={800} className="w-full" />
          </div>
          <div className="grid grid-cols-5 gap-2">
            {[1, 2, 3, 4, 5].map((_, index) => (
              <Image key={index} src={`/images/asgaard-thumbnail-${index + 1}.jpg`} alt={`Thumbnail ${index + 1}`} width={100} height={100} className="rounded-lg cursor-pointer" />
            ))}
          </div>
        </div>
