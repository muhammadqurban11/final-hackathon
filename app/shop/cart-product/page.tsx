...
const ProductPage = () => {
  return (
    <div className="relative">
      <div className="absolute top-[-60px] right-0 p-4 bg-[#FFFFFF] bg-opacity-50 text-black flex items-center space-x-2 max-w-6xl">
        <Image src='/cart-product/img-01.png' alt='sofa-image' width='40' height='40' className="bg-yellow-200 p-2 object-cover" />
        <div className="flex flex-col items-start">
          <span>Shopping Cart</span>
          <span className="block border-b-2 border-black w-24 h-2 mt-2"></span>
        </div>
        <CiLock />
      </div>
