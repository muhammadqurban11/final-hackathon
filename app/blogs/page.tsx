        ...
        <div className="bg-white">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                    ...
                    <div key={blog.id} className="flex flex-col items-center text-center bg-gray-50 rounded-lg shadow-md overflow-hidden">
                        {/* Image Section */}
                        ...
                        <div className="px-6 py-4">
                            ...
                            <p className="mt-4  font-semibold underline decoration-2">Read More </p>
                            <div className="flex items-center justify-center gap-4 mt-4 text-sm text-gray-500">
                                <span className="flex items-center gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-2.21 0-4 1.79-4 4 0 2.21 1.79 4 4 4s4-1.79 4-4-1.79-4-4-4z" />
                                    </svg>
                                    {blog.readTime}
                                </span>
                                <span className="flex items-center gap-1">
            ...
            <div className="text-center mt-12">
                <a href="#" className="text-black text-lg underline decoration-2 hover:text-gray-600"> View All Post</a>
            </div>
        </div>
    );
};
